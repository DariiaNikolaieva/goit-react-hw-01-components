...
import styles from "./svg-styles.module.css";

const ViewsIcon = () => {
  return (
    <svg className={styles.ViewsIcon} viewBox="0 0 489.935 489.935">
      <g>
        <path
          d="M486.617,255.067c4.6-6.3,4.4-14.9-0.5-21c-74.1-91.1-154.1-137.3-237.9-137.3c-142.1,0-240.8,132.4-244.9,138
        ...
        />
        <path
          d="M244.917,157.867c-48,0-87.1,39.1-87.1,87.1s39.1,87.1,87.1,87.1s87.1-39.1,87.1-87.1S292.917,157.867,244.917,157.867z
